...
$vf_config = array(
     ...
     */
    'emailRecipients' => 'real-noteru@mail.ru',
     ...
     */
    'emailSender' => 'real-noteru@mail.ru'
    /*** /Code Snippet - quick-start ***/
);
...
$subject = 'Сообщение от: '.$vfSender->data['name'];

// Define here content of the e-mail message
$content = "Новое сообщение с сайта OKE.SU:

IP адрес: ".Utils::getIp()."
Имя: {NAME}
E-mail: {EMAIL}
Телефон: {TEL}
Отдел: {DEPARTMENT}
