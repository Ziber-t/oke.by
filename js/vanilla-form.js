...
var VanillaForm = (function (window) {
    ...
    function VanillaForm(form) {
        ...
        self.dict = {
            "markedAsSpamError": "Ваше сообщение помечено как СПАМ и не было отправлено! Исправьте ваше сообщение!",
            "markedAsSpamServerError": "Ваше сообщение было помечено как СПАМ и не было отправлено.",
            "sendSuccess": "Сообщение успешно отправлено!",
            "sendError": "Произошла ошибка. Пожалуйста, попробуйте еще раз.",
            "httpRequestError": "[%s] Возникла проблема с получением ответа от почтового сервера.",
            "timeoutError": "Пожалуйста, попробуйте еще раз.",
            "parseResponseError": "Ошибка! Обратитесь к администратору."
        };
