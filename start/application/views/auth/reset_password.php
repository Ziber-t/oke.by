    		...
    		<div class="col-md-4 col-md-offset-4">
    			...
    			<form role="form" action="<?php echo site_url("auth/reset_password/".$code);?>" method="post">
    				...
    				<div class="input-group">
    			    	...
    			    	<input type="password" class="form-control" pattern="^.{8}.*$" id="new" value="" name="new" placeholder="Введите новый пароль">
   					</div>
    			  	...
    			  	<div class="input-group">
    			  		...
    			  		<input type="password" class="form-control"  pattern="^.{8}.*$" id="new_confirm" value="" name="new_confirm" placeholder="Повторите новый пароль">
   					</div>
