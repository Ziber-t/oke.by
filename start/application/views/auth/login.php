...
::-moz-placeholder          {color:#fffimportant;}/* Firefox 19+ */
:-moz-placeholder           {color:#fffimportant;}/* Firefox 18- */
:-ms-input-placeholder      {color:#fffimportant;}
    		...
    		<div class="col-md-4 col-md-offset-4">
    			...
    			<form role="form" action="<?php echo site_url("auth/login");?>" method="post">
    				...
    				<div class="input-group">
    			    	...
    			    	<input type="email" class="form-control" id="identity" name="identity" placeholder="Введите email адрес">
   					</div>
